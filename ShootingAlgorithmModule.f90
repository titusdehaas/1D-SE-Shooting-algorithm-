...
contains 
   subroutine ShootingAlgorithm(gridsize, mesh, init_gridsize, init_mesh, convergence, potential, boundaryconditions, &
      ...
      !outwards_array(1) = boundaryconditions(1)
      !outwards_array(2) = boundaryconditions(2)
      !inwards_array(x_m) = boundaryconditions(3)
      !inwards_array(x_m+1) = boundaryconditions(4)
      ...
      do  ! set up convergence loop 
         ...
         do i = 2, x_m  
            outwards_array(i+1)=-outwards_array(i-1)-2*(mesh**2)*(oldlambda-potential(i)-(1.0d0/(mesh**2.0d0)))*outwards_array(i) 
         end do 

         do i = x_m, 2, -1 
            inwards_array(i-1)=-inwards_array(i+1)-2*(mesh**2)*(oldlambda-potential(i)-(1.0d0/(mesh**2.0d0)))*inwards_array(i)
         end do 
         ...
         !weighed_integral_in = (1.0d0/(inwards_array(2)**2.0d0))*integral_inward
